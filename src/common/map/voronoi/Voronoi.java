...
public class Voronoi {
	 ...
	 * @return
	 */
	public List<GraphEdge> generateVoronoi(double[] xValuesIn,
			double[] yValuesIn, double minX, double maxX, double minY,
			double maxY) {
	...
	private void pushGraphEdge(Site leftSite, Site rightSite, double x1,
